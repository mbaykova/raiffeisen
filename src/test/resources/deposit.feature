...
#    * поле "Выслать код" доступно
    ...
    * выпадающий список "Отделение банка" заполняется значением "688, дополнительный офис «Отделение «Митино»"

    * выполнено нажатие на "Я подтверждаю"
    * выполнено нажатие на "Вперёд"

    * поле "Код из СМС" присутствует
